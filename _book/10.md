...
```
##             Estimate Est.Error   Q2.5  Q97.5
## Intercept      5.698     0.234  5.232  6.149
## D1            -0.300     0.343 -0.970  0.367
## D2            -0.193     0.312 -0.789  0.437
## sexism_p      -0.476     0.206 -0.897 -0.065
## D1:sexism_p    0.907     0.288  0.359  1.490
## D2:sexism_p    0.787     0.275  0.257  1.324
```
...
##   key                   median     ll    ul
##   <fct>                  <dbl>  <dbl> <dbl>
## 1 Model without D1 + D2  0.139  0.051 0.244
## 2 Model with D1 + D2     0.156  0.066 0.257
## 3 The R2 difference      0.017 -0.124 0.152
```
...
```
##             Estimate Est.Error   Q2.5  Q97.5
## Intercept      5.282     0.157  4.970  5.590
## D1             0.491     0.227  0.030  0.928
## D2             0.500     0.216  0.078  0.923
## sexism_p      -0.470     0.205 -0.865 -0.069
## D1:sexism_p    0.902     0.289  0.328  1.464
## D2:sexism_p    0.777     0.278  0.226  1.317
```
...
##   key                   median     ll    ul
##   <fct>                  <dbl>  <dbl> <dbl>
## 1 Model without D1 + D2  0.1    0.027 0.197
## 2 Model with D1 + D2     0.156  0.066 0.258
## 3 The R2 difference      0.054 -0.077 0.187
```
...
```
##             Estimate Est.Error   Q2.5  Q97.5
## Intercept      4.920     0.234  4.466  5.385
## D1             1.184     0.310  0.557  1.791
## D2             1.093     0.322  0.470  1.716
## sexism_p      -0.469     0.207 -0.883 -0.065
## D1:sexism_p    0.897     0.293  0.335  1.471
## D2:sexism_p    0.772     0.280  0.215  1.297
```
...
##   key                   median    ll    ul
##   <fct>                  <dbl> <dbl> <dbl>
## 1 Model without D1 + D2  0.027 0.003 0.09 
## 2 Model with D1 + D2     0.154 0.061 0.255
## 3 The R2 difference      0.123 0.016 0.233
```
