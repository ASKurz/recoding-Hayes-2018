...
```{r model9.1_9.2, echo = F}
# save(model9.1, file = "fits/model09.01.rda")
# save(model9.2, file = "fits/model09.02.rda")
# rm(model9.1)
# rm(model9.2)

load("fits/model09.01.rda")
load("fits/model09.02.rda")
```
...
```{r model9.3_9.5, echo = F}
# save(model9.3, file = "fits/model09.03.rda")
# save(model9.4, file = "fits/model09.04.rda")
# save(model9.5, file = "fits/model09.05.rda")
# rm(model9.3)
# rm(model9.4)
# rm(model9.5)

load("fits/model09.03.rda")
load("fits/model09.04.rda")
load("fits/model09.05.rda")
```
...
```{r model9.6, echo = F}
# save(model9.6, file = "fits/model09.06.rda")
# rm(model9.6)

load("fits/model09.06.rda")
```
...
```{r model9.7, echo = F}
# save(model9.7, file = "fits/model09.07.rda")
# rm(model9.7)

load("fits/model09.07.rda")
```
...
```{r model9.8, echo = F}
# save(model9.8, file = "fits/model09.08.rda")
# rm(model9.8)

load("fits/model09.08.rda")
```
...
```{r model9.9, echo = F}
# save(model9.9, file = "fits/model09.09.rda")
# rm(model9.9)

load("fits/model09.09.rda")
```
...
```{r model9.10, echo = F}
# save(model9.10, file = "fits/model09.10.rda")
# rm(model9.10)

load("fits/model09.10.rda")
```
...
```{r model9.11_9.12, echo = F}
# save(model9.11, file = "fits/model09.11.rda")
# save(model9.12, file = "fits/model09.12.rda")
# rm(model9.11)
# rm(model9.12)

load("fits/model09.11.rda")
load("fits/model09.12.rda")
```
...
```{r model9.13, echo = F}
# save(model9.13, file = "fits/model09.13.rda")
# rm(model9.13)

load("fits/model09.13.rda")
```
