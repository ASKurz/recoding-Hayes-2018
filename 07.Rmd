...
```{r model7.1}
# save(model7.1, file = "fits/model07.01.rda")
# rm(model7.1)

load("fits/model07.01.rda")
```
...
```{r model7.2_model7.3}
# save(model7.2, file = "fits/model07.02.rda")
# rm(model7.2)
# save(model7.3, file = "fits/model07.03.rda")
# rm(model7.3)

load("fits/model07.02.rda")
load("fits/model07.03.rda")
```
...
```{r model7.4}
# save(model7.4, file = "fits/model07.04.rda")
# rm(model7.4)

load("fits/model07.04.rda")
```
...
```{r model7.5}
# save(model7.5, file = "fits/model07.05.rda")
# rm(model7.5)

load("fits/model07.05.rda")
```
...
The first two columns in Hayes' Table 7.5 contain the values he combined with the point estimates of his model to get the $\hat Y$ column. The way we'll push those values through `model7.3`'s posterior is with `brms::fitted()`. As a preparatory step, we'll put the predictor values in a data object, `nd`.
...
```{r model7.6_model7.7}
# save(model7.6, file = "fits/model07.06.rda")
# rm(model7.6)
# save(model7.7, file = "fits/model07.07.rda")
# rm(model7.7)

load("fits/model07.06.rda")
load("fits/model07.07.rda")
```
