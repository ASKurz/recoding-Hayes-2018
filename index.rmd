...
all fit objects in the book are new saved in `.rda` files in the [`fits` folder](https://github.com/ASKurz/recoding-Hayes-2018/tree/master/fits) on GitHub,
* I have substantially increased the amount of Hayes quotes,
* I have added more statistical formulas throughout the text, and
* I have added a version of Chapter 14, which includes warnings about relying on cross-sectional mediation.
...
We'll see. In the meantime, feel free to make suggestions or report typos or coding goofs [here](https://github.com/ASKurz/recoding-Hayes-2018/issues).
