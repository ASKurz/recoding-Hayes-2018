...
#> 3 The R2 difference 0.084  0.085 -0.033 0.201
```
...
#> D2:sexism_p    0.788     0.275  0.260  1.322
```
...
#> 3 The R2 difference      0.013 -0.126 0.149
```
...
#> D2:sexism_p    0.780     0.284  0.219  1.352
```
...
#> 3 The R2 difference      0.054 -0.075 0.182
```
...
#> D2:sexism_p    0.775     0.272  0.261  1.321
```
...
#> 3 The R2 difference      0.124 0.022 0.232
```
...
<img src="10_files/figure-html/unnamed-chunk-27-1.png" width="576" />
...
#> 5 difference_b       -0.172 0.312 -0.802 0.434
```
...
#> 5 difference_b       0.497 0.22  0.053 0.915
```
...
#> 5 difference_b        1.16 0.335 0.497  1.82
```
...
<img src="10_files/figure-html/unnamed-chunk-34-1.png" width="576" />
...
<img src="10_files/figure-html/unnamed-chunk-38-1.png" width="960" />
...
#> 3 Collective Protest  0.305 0.185 -0.07   0.67
```
...
#> 3 Individual Protest - Collective Protest 0.122 0.274 -0.4   0.667
```
