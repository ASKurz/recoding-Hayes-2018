...
```{r model8.1, echo = F}
# save(model8.1, file = "fits/model08.01.rda")
# rm(model8.1)

load("fits/model08.01.rda")
```
...
```{r model8.2, echo = F}
# save(model8.2, file = "fits/model08.02.rda")
# rm(model8.2)

load("fits/model08.02.rda")
```
...
```{r model8.3, echo = F}
# save(model8.3, file = "fits/model08.03.rda")
# rm(model8.3)

load("fits/model08.03.rda")
```
...
```{r model8.4, echo = F}
# save(model8.4, file = "fits/model08.04.rda")
# rm(model8.4)

load("fits/model08.04.rda")
```
...
```{r model8.5, echo = F}
# save(model8.5, file = "fits/model08.05.rda")
# rm(model8.5)

load("fits/model08.05.rda")
```
...
```{r model8.6, echo = F}
# save(model8.6, file = "fits/model08.06.rda")
# rm(model8.6)

load("fits/model08.06.rda")
```
...
```{r model8.7_model_8.8, echo = F}
# save(model8.7, file = "fits/model08.07.rda")
# rm(model8.7)
# save(model8.8, file = "fits/model08.08.rda")
# rm(model8.8)

load("fits/model08.07.rda")
load("fits/model08.08.rda")
```
...
```{r model8.9, echo = F}
# save(model8.9, file = "fits/model08.09.rda")
# rm(model8.9)

load("fits/model08.09.rda")
```
