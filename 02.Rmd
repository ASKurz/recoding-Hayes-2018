...
```{r model2.1}
# save(model2.1, file = "fits/model2.1.rda")
# rm(model2.1)

load("fits/model2.1.rda")
```
...
```{r model2.3}
# save(model2.3, file = "fits/model2.3.rda")
# rm(model2.3)

load("fits/model2.3.rda")
```
...
```{r model2.4}
# save(model2.4, file = "fits/model2.4.rda")
# rm(model2.4)

load("fits/model2.4.rda")
```
...
```{r model2.5}
# save(model2.5, file = "fits/model2.5.rda")
# rm(model2.5)

load("fits/model2.5.rda")
```
...
```{r model2.6}
# save(model2.6, file = "fits/model2.6.rda")
# rm(model2.6)

load("fits/model2.6.rda")
```
...
```{r model2.7}
# save(model2.7, file = "fits/model2.7.rda")
# rm(model2.7)

load("fits/model2.7.rda")
```
...
```{r model2.8}
# save(model2.8, file = "fits/model2.8.rda")
# rm(model2.8)

load("fits/model2.8.rda")
```
...
```{r model2.9}
# save(model2.9, file = "fits/model2.9.rda")
# rm(model2.9)

load("fits/model2.9.rda")
```
...
```{r model2.10}
# save(model2.10, file = "fits/model2.10.rda")
# rm(model2.10)

load("fits/model2.10.rda")
```
...
```{r model2.11}
# save(model2.11, file = "fits/model2.11.rda")
# rm(model2.11)
...
```{r model2.12}
# save(model2.12, file = "fits/model2.12.rda")
# rm(model2.12)

load("fits/model2.12.rda")
```
...
```{r model2.13}
# save(model2.13, file = "fits/model2.13.rda")
# rm(model2.13)

load("fits/model2.13.rda")
```
