...
```{r model10.1_10.2}
# save(model10.1, file = "fits/model10.01.rda")
# save(model10.2, file = "fits/model10.02.rda")
# rm(model10.1)
# rm(model10.2)

load("fits/model10.01.rda")
load("fits/model10.02.rda")
```
...
```{r model10.3a_10.4a}
# save(model10.3a, file = "fits/model10.03a.rda")
# save(model10.4a, file = "fits/model10.04a.rda")
# rm(model10.3a)
# rm(model10.4a)

load("fits/model10.03a.rda")
load("fits/model10.04a.rda")
```
...
```{r model10.3b_10.4b}
# save(model10.3b, file = "fits/model10.03b.rda")
# save(model10.4b, file = "fits/model10.04b.rda")
# rm(model10.3b)
# rm(model10.4b)

load("fits/model10.03b.rda")
load("fits/model10.04b.rda")
```
...
```{r model10.3c_10.4c}
# save(model10.3c, file = "fits/model10.03c.rda")
# save(model10.4c, file = "fits/model10.04c.rda")
# rm(model10.3c)
# rm(model10.4c)

load("fits/model10.03c.rda")
load("fits/model10.04c.rda")
```
