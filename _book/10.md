...
```
##             Estimate Est.Error   Q2.5  Q97.5
## Intercept      5.700     0.231  5.253  6.164
## D1            -0.298     0.336 -0.962  0.357
## D2            -0.187     0.313 -0.788  0.408
## sexism_p      -0.473     0.205 -0.874 -0.064
## D1:sexism_p    0.900     0.287  0.327  1.448
## D2:sexism_p    0.780     0.274  0.240  1.308
```
...
##   key                   median     ll    ul
##   <fct>                  <dbl>  <dbl> <dbl>
## 1 Model without D1 + D2  0.138  0.053 0.241
## 2 Model with D1 + D2     0.156  0.064 0.254
## 3 The R2 difference      0.016 -0.12  0.148
```
...
```
##             Estimate Est.Error   Q2.5  Q97.5
## Intercept      5.284     0.159  4.974  5.595
## D1             0.487     0.226  0.049  0.937
## D2             0.493     0.222  0.062  0.926
## sexism_p      -0.470     0.214 -0.886 -0.058
## D1:sexism_p    0.901     0.291  0.339  1.468
## D2:sexism_p    0.774     0.284  0.212  1.333
```
...
##   key                   median     ll    ul
##   <fct>                  <dbl>  <dbl> <dbl>
## 1 Model without D1 + D2  0.099  0.029 0.193
## 2 Model with D1 + D2     0.156  0.065 0.255
## 3 The R2 difference      0.055 -0.076 0.181
```
...
```
## Warning: Found 1 observations with a pareto_k > 0.7 in model 'model3'. It is recommended to set
...
```
##             Estimate Est.Error   Q2.5  Q97.5
## Intercept      4.918     0.232  4.440  5.367
## D1             1.185     0.313  0.582  1.836
## D2             1.090     0.313  0.475  1.714
## sexism_p      -0.471     0.208 -0.886 -0.075
## D1:sexism_p    0.903     0.292  0.338  1.493
## D2:sexism_p    0.772     0.279  0.223  1.332
```
...
##   key                   median    ll    ul
##   <fct>                  <dbl> <dbl> <dbl>
## 1 Model without D1 + D2  0.027 0.002 0.094
## 2 Model with D1 + D2     0.154 0.064 0.261
## 3 The R2 difference      0.123 0.016 0.234
```
