...
```{r model4.1}
# save(model4.1, file = "fits/model04.01.rda")
# rm(model4.1)

load("fits/model04.01.rda")
```
...
```{r model4.2}
# save(model4.2, file = "fits/model04.02.rda")
# rm(model4.2)

load("fits/model04.02.rda")
```
...
bayes_R2(model4.2, summary = F) %>% 
  ...
  scale_y_continuous(NULL, breaks = NULL) +
  xlim(0:1) +
  labs(title = expression(paste("The ", italic("R")^{2}, " distributions for model4.2")),
       x = NULL) +
  theme_black() +
  theme(panel.grid = element_blank())
```
...
```{r model4.3}
# save(model4.3, file = "fits/model04.03.rda")
# rm(model4.3)

load("fits/model04.03.rda")
```
...
```{r model4.4}
# save(model4.4, file = "fits/model04.04.rda")
# rm(model4.4)

load("fits/model04.04.rda")
```
...
```{r model4.5}
# save(model4.5, file = "fits/model04.05.rda")
# rm(model4.5)

load("fits/model04.05.rda")
```
...
```{r model4.6}
# save(model4.6, file = "fits/model04.06.rda")
# rm(model4.6)

load("fits/model04.06.rda")
```
...
```{r model4.7}
# save(model4.7, file = "fits/model04.07.rda")
# rm(model4.7)

load("fits/model04.07.rda")
```
