...
## 3 The R2 difference 0.087  0.087 -0.035 0.208
```
...
## d2:sexism_p    0.769     0.284  0.217  1.328
```
...
## 3 The R2 difference     0.015 -0.124  0.146   0.95 median qi
```
...
## model10.4a   -1.4       0.8  -187.3     10.9         7.9    2.0    374.7   21.8
```
...
## d2:sexism_p    0.774     0.277  0.230  1.315
```
...
## 3 The R2 difference     0.052 -0.08   0.185   0.95 median qi
```
...
## model10.3b   -1.3       3.0  -188.7     11.9         6.0    1.9    377.4   23.7
```
...
## d2:sexism_p    0.775     0.274  0.223  1.315
```
...
## 3 The R2 difference     0.121  0.023  0.23    0.95 median qi
```
...
## model10.3c   -6.6       5.5  -193.7     13.3         5.7    1.9    387.4   26.7
```
...
## 18 w - 5.896 d2:sexism_p    0.775     0.274  0.223  1.315
```
...
## 18 w - 5.896 d2:sexism_p    0.775     0.274  0.223  1.32
```
...
## 5 difference_b       -0.192 -0.824  0.42
```
...
## 5 difference_b       0.487  0.081  0.914
```
...
## 5 difference_b        1.16  0.492   1.85
```
...
<img src="10_files/figure-html/unnamed-chunk-35-1.png" width="576" />
...
## 1      0.087 -0.035  0.208   0.95 mean   qi
```
...
<img src="10_files/figure-html/unnamed-chunk-41-1.png" width="960" />
...
## 3 Collective Protest  0.306 -0.065  0.677   0.95 mean   qi
```
...
## 3 Individual Protest - Collective Protest 0.125 -0.428  0.668   0.95 mean   qi
```
