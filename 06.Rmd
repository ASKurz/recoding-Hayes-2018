...
```{r model6.1, echo = F}
# save(model6.1, file = "fits/model06.01.rda")
# rm(model6.1)

load("fits/model06.01.rda")
```
...
```{r model6.2, echo = F}
# save(model6.2, file = "fits/model06.02.rda")
# rm(model6.2)

load("fits/model06.02.rda")
```
...
```{r model6.3, echo = F}
# save(model6.3, file = "fits/model06.03.rda")
# rm(model6.3)

load("fits/model06.03.rda")
```
...
```{r model6.4, echo = F}
# save(model6.4, file = "fits/model06.04.rda")
# rm(model6.4)

load("fits/model06.04.rda")
```
...
```{r model6.5, echo = F}
# save(model6.5, file = "fits/model06.05.rda")
# rm(model6.5)

load("fits/model06.05.rda")
```
...
```{r model6.6, echo = F}
# save(model6.6, file = "fits/model06.06.rda")
# rm(model6.6)

load("fits/model06.06.rda")
```
