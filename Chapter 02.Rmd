...
As Hayes wrote, now `sex` = `r fixef(model4_z_p)[5] %>% round(3)` has a sensible interpretation. "We can say that men and women differ by [`r fixef(model4_z_p)[5] %>% round(3)`] standard deviations in their support for government action when all other variables in the model are held constant (p. 53)."
