...
```
##             Estimate Est.Error   Q2.5  Q97.5
## Intercept      5.693     0.236  5.218  6.149
## D1            -0.290     0.344 -0.956  0.391
## D2            -0.178     0.319 -0.804  0.442
## sexism_p      -0.465     0.208 -0.863 -0.055
## D1:sexism_p    0.892     0.292  0.323  1.466
## D2:sexism_p    0.769     0.281  0.226  1.310
```
...
##   key                   median     ll    ul
##   <fct>                  <dbl>  <dbl> <dbl>
## 1 Model without D1 + D2  0.14   0.053 0.244
## 2 Model with D1 + D2     0.155  0.061 0.251
## 3 The R2 difference      0.013 -0.124 0.147
```
...
```
##             Estimate Est.Error   Q2.5  Q97.5
## Intercept      5.283     0.156  4.978  5.587
## D1             0.488     0.221  0.051  0.921
## D2             0.493     0.221  0.065  0.924
## sexism_p      -0.472     0.218 -0.899 -0.050
## D1:sexism_p    0.901     0.305  0.318  1.483
## D2:sexism_p    0.778     0.293  0.234  1.356
```
...
##   key                   median     ll    ul
##   <fct>                  <dbl>  <dbl> <dbl>
## 1 Model without D1 + D2  0.101  0.026 0.196
## 2 Model with D1 + D2     0.156  0.064 0.26 
## 3 The R2 difference      0.054 -0.081 0.186
```
...
```
##             Estimate Est.Error   Q2.5  Q97.5
## Intercept      4.920     0.236  4.466  5.377
## D1             1.187     0.314  0.571  1.813
## D2             1.093     0.321  0.469  1.712
## sexism_p      -0.473     0.209 -0.887 -0.058
## D1:sexism_p    0.906     0.296  0.330  1.481
## D2:sexism_p    0.778     0.282  0.215  1.329
```
...
##   key                   median    ll    ul
##   <fct>                  <dbl> <dbl> <dbl>
## 1 Model without D1 + D2  0.027 0.002 0.088
## 2 Model with D1 + D2     0.156 0.064 0.259
## 3 The R2 difference      0.124 0.017 0.232
```
