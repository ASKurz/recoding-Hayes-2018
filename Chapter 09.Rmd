...
On page 309, Hayes explanied why the OLS variance for *b*~3~ is unaffected by mean-centering. The story was similar for our HMC model, too:
...
Our `print()` output matches farily well with the OLS results on pages 332 and 333. Our new Bayesian $R^2$ is:
