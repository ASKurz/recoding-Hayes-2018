...
```{r model13.1}
# save(model13.1, file = "fits/model13.01.rda")
# rm(model13.1)

load("fits/model13.01.rda")
```
...
```{r model13.2}
# save(model13.2, file = "fits/model13.02.rda")
# rm(model13.2)

load("fits/model13.02.rda")
```
...
```{r model13.3}
# save(model13.3, file = "fits/model13.03.rda")
# rm(model13.3)

load("fits/model13.03.rda")
```
