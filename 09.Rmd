...
```{r model9.1, warning = F, message = F}
model9.1 <- 
  brm(data = glbwarm, 
      family = gaussian,
...
```{r model9.6, warning = F, message = F}
model9.6 <- 
  update(model9.1, 
         newdata = glbwarm,
...
```{r model9.7, warning = F, message = F}
model9.7 <- 
  update(model9.1, 
         newdata = glbwarm,
...
```{r model9.8, warning = F, message = F}
model9.8 <- 
  update(model9.6, 
         newdata = glbwarm,
...
```{r model9.10, warning = F, message = F}
model9.10 <- 
  update(model9.1, 
         newdata = glbwarm,
...
```{r model9.11, warning = F, message = F}
model9.11 <- 
  update(model9.10, 
         newdata = glbwarm,
...
```{r model9.13, warning = F, message = F}
model9.13 <- 
  update(model9.10, 
         newdata = glbwarm,
