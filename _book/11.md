...
#> $ perform <dbl> 0.12, 0.52, -0.08, -0.08, 0.12, 1.12, -0.28, 0.32, -1....
```
...
#> R2_perform    0.320     0.079 0.148 0.456
```
...
#> 6 Conditional indirect effect when W is 0.600  -0.46  0.172 -0.825 -0.169
```
...
<img src="11_files/figure-html/unnamed-chunk-13-1.png" width="336" />
...
#> 3 Conditional indirect effect when W is 0.600  -0.46  0.172 -0.825 -0.169
```
...
#> 3 Conditional indirect effect when W is 0… -0.378   -0.805    -0.149  0.95
```
...
<img src="11_files/figure-html/unnamed-chunk-17-1.png" width="576" />
