...
## d2        0.4403257 0.2230260 0.01108483 0.8737501
```
...
```
##      Estimate  Est.Error        Q2.5    Q97.5
## R2 0.05809419 0.03583401 0.006216829 0.139659
```
...
## 7 i_y       3.71   3.11   4.32    0.95 mean   qi
```
...
## 2 a2b   0.66   0.378  0.989   0.95 mean   qi
```
...
## liking_respappr     0.4113725 0.0711161  0.2695799 0.5478882
```
...
## 3       b_respappr_d_2 0.3500687 0.2494522 -0.1309177 0.8269577
```
...
## 2 a2b   0.144 -0.053  0.368   0.95 mean   qi
```
...
## 3 a3b    2.26   1.46   3.08   0.95 mean   qi
```
...
## 3 diff_individual_minus_none       0.519  0.27   0.823   0.95 mean   qi
```
