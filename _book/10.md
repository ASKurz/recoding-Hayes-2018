...
```
##             Estimate Est.Error   Q2.5  Q97.5
## Intercept      5.696     0.237  5.225  6.160
## D1            -0.293     0.342 -0.957  0.373
## D2            -0.185     0.315 -0.817  0.423
## sexism_p      -0.471     0.207 -0.871 -0.081
## D1:sexism_p    0.895     0.286  0.331  1.456
## D2:sexism_p    0.777     0.276  0.256  1.316
```
...
##   key                   median     ll    ul
##   <fct>                  <dbl>  <dbl> <dbl>
## 1 Model without D1 + D2  0.138  0.05  0.241
## 2 Model with D1 + D2     0.152  0.064 0.255
## 3 The R2 difference      0.017 -0.12  0.151
```
...
```
##             Estimate Est.Error   Q2.5  Q97.5
## Intercept      5.287     0.153  4.988  5.586
## D1             0.485     0.221  0.058  0.922
## D2             0.493     0.218  0.073  0.922
## sexism_p      -0.471     0.214 -0.896 -0.043
## D1:sexism_p    0.903     0.301  0.320  1.507
## D2:sexism_p    0.779     0.284  0.240  1.350
```
...
##   key                   median     ll    ul
##   <fct>                  <dbl>  <dbl> <dbl>
## 1 Model without D1 + D2  0.101  0.027 0.195
## 2 Model with D1 + D2     0.155  0.063 0.257
## 3 The R2 difference      0.054 -0.078 0.183
```
...
```
##             Estimate Est.Error   Q2.5  Q97.5
## Intercept      4.923     0.230  4.472  5.373
## D1             1.181     0.309  0.555  1.777
## D2             1.094     0.318  0.473  1.714
## sexism_p      -0.472     0.206 -0.873 -0.063
## D1:sexism_p    0.896     0.290  0.322  1.462
## D2:sexism_p    0.780     0.275  0.238  1.312
```
...
##   key                   median    ll    ul
##   <fct>                  <dbl> <dbl> <dbl>
## 1 Model without D1 + D2  0.027 0.003 0.093
## 2 Model with D1 + D2     0.154 0.063 0.254
## 3 The R2 difference      0.122 0.015 0.228
```
...
##  [1] brms_2.3.1      Rcpp_0.12.17    bindrcpp_0.2.2  forcats_0.3.0   stringr_1.3.1   dplyr_0.7.6    
