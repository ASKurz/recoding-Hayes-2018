...
```
##             Estimate Est.Error   Q2.5  Q97.5
## Intercept      5.702     0.234  5.248  6.188
## D1            -0.304     0.348 -0.987  0.369
## D2            -0.187     0.317 -0.833  0.435
## sexism_p      -0.475     0.209 -0.894 -0.069
## D1:sexism_p    0.905     0.289  0.364  1.474
## D2:sexism_p    0.782     0.281  0.231  1.344
```
...
##   key                   median     ll    ul
##   <fct>                  <dbl>  <dbl> <dbl>
## 1 Model without D1 + D2  0.138  0.048 0.243
## 2 Model with D1 + D2     0.155  0.064 0.257
## 3 The R2 difference      0.017 -0.123 0.147
```
...
```
##             Estimate Est.Error   Q2.5  Q97.5
## Intercept      5.288     0.160  4.975  5.605
## D1             0.481     0.225  0.044  0.928
## D2             0.486     0.223  0.042  0.921
## sexism_p      -0.468     0.213 -0.883 -0.042
## D1:sexism_p    0.900     0.292  0.315  1.469
## D2:sexism_p    0.775     0.284  0.229  1.322
```
...
##   key                   median     ll    ul
##   <fct>                  <dbl>  <dbl> <dbl>
## 1 Model without D1 + D2  0.098  0.029 0.195
## 2 Model with D1 + D2     0.154  0.06  0.255
## 3 The R2 difference      0.053 -0.076 0.18
```
...
```
##             Estimate Est.Error   Q2.5  Q97.5
## Intercept      4.910     0.237  4.451  5.381
## D1             1.204     0.313  0.596  1.825
## D2             1.111     0.332  0.458  1.768
## sexism_p      -0.480     0.205 -0.877 -0.089
## D1:sexism_p    0.914     0.294  0.344  1.484
## D2:sexism_p    0.789     0.281  0.226  1.329
```
...
## 2 Model with D1 + D2     0.158 0.065 0.263
## 3 The R2 difference      0.127 0.019 0.236
```
