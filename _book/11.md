...
## negtone_Intercept         0.026     0.064   -0.096    0.153 1.000     5888     3142
## perform_Intercept        -0.013     0.060   -0.134    0.109 1.000     5954     2964
## negtone_dysfunc           0.619     0.171    0.271    0.957 1.000     6341     2612
## perform_dysfunc           0.367     0.178    0.008    0.721 1.001     5523     3279
## perform_negtone          -0.437     0.131   -0.690   -0.174 1.002     5046     3263
## perform_negexp           -0.018     0.121   -0.261    0.220 1.000     6041     3040
## perform_negtone:negexp   -0.513     0.244   -0.999   -0.049 1.000     5465     3164
## 
## Family Specific Parameters: 
##               Estimate Est.Error l-95% CI u-95% CI  Rhat Bulk_ESS Tail_ESS
## sigma_negtone    0.487     0.046    0.409    0.584 1.001     6533     3070
## sigma_perform    0.458     0.044    0.383    0.554 1.000     5592     3018
## 
...
## R2negtone    0.193     0.079 0.041 0.346
## R2perform    0.320     0.076 0.161 0.457
```
...
```
##                          Estimate Est.Error       Q2.5       Q97.5
## perform_negtone        -0.4366037 0.1307509 -0.6897111 -0.17382009
## perform_negtone:negexp -0.5133470 0.2437876 -0.9989530 -0.04875965
```
...
##    <dbl> <dbl>              <dbl>                       <dbl>
## 1 -0.531 0.619             -0.164                      -0.101
## 2 -0.006 0.619             -0.434                      -0.268
## 3  0.6   0.619             -0.745                      -0.461
```
...
##    <dbl>         <dbl>  <dbl>  <dbl>
## 1 -0.531        -0.101 -0.39   0.168
## 2 -0.006        -0.268 -0.511 -0.079
## 3  0.6          -0.461 -0.836 -0.173
```
...
##        w `a(b1 + b3w)` .lower .upper
##    <dbl>         <dbl>  <dbl>  <dbl>
## 1 -0.531        -0.07  -0.395  0.157
## 2 -0.006        -0.246 -0.497 -0.069
## 3  0.6          -0.438 -0.782 -0.143
```
...
##  [46] xtable_1.8-4         HDInterval_0.2.2     stats4_4.0.4         StanHeaders_2.21.0-7 DT_0.16             
##  [51] htmlwidgets_1.5.3    httr_1.4.2           threejs_0.3.3        arrayhelpers_1.1-0   posterior_1.0.1     
##  [56] ellipsis_0.3.2       pkgconfig_2.0.3      loo_2.4.1            farver_2.1.0         sass_0.3.1          
##  [61] dbplyr_2.1.1         utf8_1.2.1           tidyselect_1.1.1     labeling_0.4.2       rlang_0.4.11        
...
## [106] jquerylib_0.1.4      bridgesampling_1.0-0 estimability_1.3     httpuv_1.6.0         R6_2.5.0            
## [111] bookdown_0.22        promises_1.2.0.1     gridExtra_2.3        codetools_0.2-18     boot_1.3-26         
## [116] colourpicker_1.1.0   MASS_7.3-53          gtools_3.8.2         assertthat_0.2.1     withr_2.4.2         
## [121] shinystan_2.5.0      multcomp_1.4-16      mgcv_1.8-33          parallel_4.0.4       hms_1.1.0           
## [126] grid_4.0.4           coda_0.19-4          minqa_1.2.4          rmarkdown_2.8        shiny_1.6.0         
## [131] lubridate_1.7.10     base64enc_0.1-3      dygraphs_1.1.1.6
```
