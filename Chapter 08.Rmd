...
1. $Y$_hat = `r post[1, 1] %>% round(3)` + `r post[1, 2] %>% round(3)`$X$ + `r post[1, 3] %>% round(3)`$W$ + `r post[1, 4] %>% round(3)`*XW*
2. $Y$_hat = `r post[2, 1] %>% round(3)` + `r post[2, 2] %>% round(3)`$X$ + `r post[2, 3] %>% round(3)`$W$ + `r post[2, 4] %>% round(3)`*XW*
3. $Y$_hat = `r post[3, 1] %>% round(3)` + `r post[3, 2] %>% round(3)`$X$ + `r post[3, 3] %>% round(3)`$W$ + `r post[3, 4] %>% round(3)`*XW*
4. $Y$_hat = `r post[4, 1] %>% round(3)` + `r post[4, 2] %>% round(3)`$X$ + `r post[4, 3] %>% round(3)`$W$ + `r post[4, 4] %>% round(3)`*XW*
5. $Y$_hat = `r post[5, 1] %>% round(3)` + `r post[5, 2] %>% round(3)`$X$ + `r post[5, 3] %>% round(3)`$W$ + `r post[5, 4] %>% round(3)`*XW*
6. $Y$_hat = `r post[6, 1] %>% round(3)` + `r post[6, 2] %>% round(3)`$X$ + `r post[6, 3] %>% round(3)`$W$ + `r post[6, 4] %>% round(3)`*XW*
...
Like with `fit4`, above, we'll need a bit of algebra to compute our $Y$-bar~*i*~ vectors.
